  ...
  return (
    <div className="bg-bgLight dark:bg-black mt-16 md:mt-5 lg:mt-8 py-5">
      <div className="container py-12 heading">
        ...
        <p className="my-8 text-center font-light">KFC TERMS OF USE</p>
        <p>
          These Terms of Use ("Terms") govern your use the KFC Corporation
          ...
          contained in this web site from time to time and we reserve the right
          to make such changes without obligation to notify past, current or
        ...
        <div className="flex flex-col justify-start items-start">
          ...
          <p>
            ...
            or misstatements). THIS SITE IS PROVIDED ON AN "AS IS, AS AVAILABLE"
            BASIS. NO WARRANTIES, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED
            TO THOSE OF MERCHANTABILITY OR FITNESS FOR A PARTICULAR PURPOSE, ARE
            MADE WITH RESPECT TO THIS SITE OR ANY INFORMATION OR SOFTWARE
            THEREIN. UNDER NO CIRCUMSTANCES, INCLUDING NEGLIGENCE, SHALL KFC BE
          ...
          <p>
            ...
            our Privacy Policy. These areas are designed to give our users the
            ability to contact us with questions or concerns, to engage in
            dialogue with us and other Site users, or to take advantage of other
            features we may provide from time to time. They are not intended
            for, and should not be used to, submit unsolicited ideas. It is
            company policy not to accept such unsolicited ideas, concepts,
            techniques, procedures, methods, systems, designs, plans, charts or
            similar materials from outside parties. By entering the Site you
            acknowledge and agree that any materials, ideas or other
            communications you transmit to us in any manner and for any reason
            will not be treated as confidential or proprietary. It is KFC's
            policy not to accept, and to return, any unsolicited ideas,
            concepts, techniques, procedures, methods, systems, designs, plans,
            charts or other similar materials. Nevertheless, should you submit
            such materials, you understand that you have no ownership rights in
            any ideas you may submit, and you expressly disclaim any rights or
            causes of action you may have with respect to any materials you may
            submit.
          </p>
          <h1 className="text-md font-bold mt-5 mb-2">KFC PROPERTY</h1>
          <p>
          ...
          <p>
            ...
            perform, publicly display, reproduce, and distribute Submitted
            Content. This license includes the right to host, index, cache,
            distribute, and tag any Submitted Content, as well as the right to
            sublicense Submitted Content to third parties, including other
            users, for use on other platforms, such as for use on mobile phones,
            in video or music software computer programs.
          </p>
          <p>
            You represent and warrant that you own the Submitted Content
            displayed, published or posted by you on the Site and otherwise have
            the right to grant the license set forth herein, and the displaying,
            publishing or posting of your Submitted Content, and our use
            thereof, does not and will not violate the privacy rights, publicity
            ...
            monies owing any person by reason of any Submitted Content
            displayed, published or posted by you to the Site.
          </p>
          <p>
            You agree that your Submitted Content is gratuitous and made without
            restriction, and will not place KFC under any obligation. You agree
            that KFC is free to disclose the ideas contained in the Submission,
            including, for example, ingredient or menu item suggestions, on a
            ...
            acceptance of your Submission, KFC does not waive any rights to use
            similar or related ideas previously known to KFC, or developed by
          ...
          <ul className="list-disc ml-8">
            ...
            <li>
              KFC does not necessarily monitor any materials posted,
              transmitted, or communicated to or within the Site. If you believe
              that something on the Site violates these Terms please contact
              Copyright Agent, KFC Corporation, 1441 Gardiner Lane, Louisville,
              Kentucky 40213; or by email to copyright@kfc.com.
            </li>
          </ul>
          <h1 className="text-md font-bold mt-5 mb-2">ONLINE PURCHASES</h1>
          <p>
            ...
            used in accordance with our Privacy Policy. When you purchase items
            through our website, prices will be made clear during the order
            process. You agree to pay the price that is stated at the time of
            your order, as well as any applicable taxes. You also agree to have
            your credit card billed for the total amount displayed at check out.
            Please see our Return Policy.By purchasing items through the Site,
            you represent and warrant to KFC that you are capable of entering a
            contract under the laws of the United States. The most recent terms
            of use will be posted on this webpage. By agreeing to these terms,
            you also agree to future changes.
          </p>
          <h1 className="text-md font-bold mt-5 mb-2">WEB SITE ACCESS</h1>
          <p>
          ...
          <h1 className="text-md font-bold mt-5 mb-2">INDEMNIFICATION</h1>
          <p>
          ...
          <h1 className="text-md font-bold mt-5 mb-2">HYPER-LINKS</h1>
          <p>
          ...
          <h1 className="text-md font-bold mt-5 mb-2">TEXT MESSAGING NOTICE</h1>
          <p>
          ...
          <h1 className="text-md font-bold mt-5 mb-2">MISCELLANEOUS</h1>
          <p>
          ...
          <p>
            ...
            arbitration. THE ARBITRATION OF DISPUTES PURSUANT TO THIS PARAGRAPH
            SHALL BE IN YOUR INDIVIDUAL CAPACITY, AND NOT AS A PLAINTIFF OR
            CLASS MEMBER IN ANY PURPORTED CLASS OR REPRESENTATIVE PROCEEDING.
            THE ARBITRATOR MAY NOT CONSOLIDATE OR JOIN THE CLAIMS OF OTHER
            PERSONS OR PARTIES WHO MAY BE SIMILARLY SITUATED. DO NOT USE THIS
            WEBSITE OR SUBMIT CONTENT IF YOU DO NOT AGREE TO HAVE ANY CLAIM OR
          ...
          <p>
            ...
            AND CAUSES OF ACTION ARISING OUT OF OR CONNECTED WITH YOUR USE OF
            THE KFC SITE OR YOUR SUBMITTED CONTENT WILL BE RESOLVED INDIVIDUALLY
            ...
            OR RECOVERABLE; (3) UNDER NO CIRCUMSTANCES WILL YOU BE PERMITTED TO
            OBTAIN ANY AWARD FOR, AND YOU HEREBY KNOWINGLY AND EXPRESSLY WAIVES
            ...
            TO A CLAIM FOR MONEY DAMAGES (IF ANY) AND YOU IRREVOCABLY WAIVES ANY
            RIGHT TO SEEK INJUNCTIVE OR EQUITABLE RELIEF. SOME JURISDICTIONS DO
            NOT ALLOW THE LIMITATIONS OR EXCLUSION OF LIABILITY, SO THE ABOVE
          ...
          <p>
            ...
            place in the State of Kentucky, in the County of Jefferson. This
            Agreement constitutes a binding agreement between you and KFC, and
            is accepted by you upon your use of the site. This Agreement
...
export default WithAuthProtection(TermsConditions, false);
